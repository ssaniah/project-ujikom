...
<head>
    ...
    <!-- Menyusun halaman agar responsif pada perangkat dengan ukuran layar berbeda -->
    <meta http-equiv="X-UA-Compatible" content="ie=edge"> <!-- Menyatakan kompatibilitas untuk Internet Explorer -->

    <title>{{ $title }} - {{ config('app.name') }}</title>
    <!-- Menampilkan judul halaman dengan variabel dynamic ($title) dan nama aplikasi dari konfigurasi -->

    <!-- Import Bootstrap CSS Online -->
    <link rel="stylesheet" href="{{ asset('vendor/bootstrap/css/bootstrap.min.css') }}">
    <!-- Menambahkan file CSS Bootstrap untuk styling -->
    <link rel="stylesheet" href="{{ asset('vendor/bootstrap-icons/font/bootstrap-icons.css') }}">
    <!-- Menambahkan file CSS untuk ikon Bootstrap -->
</head>
...
<body>
    ...
    <!-- Menambahkan file JavaScript Bootstrap untuk fitur-fitur interaktif seperti modal, dropdown, dll. -->
</body>
